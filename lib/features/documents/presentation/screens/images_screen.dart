  ...
  Widget build(BuildContext context) {
    return BaseScaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          context.read<CreateImageFolderBloc>().add(CreateImageFolderStarted());
        },
        ...
        child: BlocBuilder<GetScannedDocumentsBloc, GetScannedDocumentsState>(
          builder: (context, getScannedDocumentsState) {
            if (getScannedDocumentsState is GetScannedDocumentsSuccess) {
              ...
              List<ImageFolder> folders = getScannedDocumentsState.imageFolders;
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color:
                                        Colors.white, // Optional border color
                                    width: 2,
                                  ),
                                ),
                              ),
